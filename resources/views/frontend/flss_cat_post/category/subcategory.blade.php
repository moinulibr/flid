    ...
    <header class="fix-head">
        <nav class="navbar navbar-light navbar-expand-md py-3">
            <div class="container">
                ...
                <a href="{{route('frontend.webview.flss.view.all.categories')}}">
                    <span class="page-title">{{isset($category) ? $category->name : null}}</span>
                </a>
        ...
        <div class="container">
            ...
            <div class="row" style="padding-bottom: 10px;">
                <div class="col" style="padding: 0 10px;;">
                    <a href="{{ route('frontend.webview.flss.post.bycategory.subcategory.index',$item->slug)}}">
                        <div class="callout">
                            <h1>{{$item->name}}</h1>
                            <p>এখানে দেখুন </p> 
                        </div>
        ...
        <div class="container">
            ...
            <div class="row" style="padding-bottom: 10px;">
                <div class="col" style="padding-left: 0; padding-right: 0;">
                    <a href="{{route('frontend.webview.flss.post.detail',[$item->slug,$category->slug])}}">
                        <div class="pos-list">
                            <span style="float:left;width: 75px;height: 75px;background-image: url({{ asset('storage/flss-post/'.$item->featured_image) }});background-size: cover;background-position: center center;border-radius: 16px;">
                            </span>
