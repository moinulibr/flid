    ...
    <nav class="navbar navbar-light navbar-expand-md py-3">
        <div class="container">
           <a href="{{route('frontend.webview.menu.list')}}">
            ...
            <span class="page-title">সমস্ত পৃষ্ঠা</span>
            </a>
    ...
    <div class="container">
        ...
        <div class="row" style="padding-bottom: 10px;">
            <div class="col" style="padding-left: 0; padding-right: 0;">
                <a href="{{route('frontend.webview.about.us.view',$item->slug)}}">
                    <div class="pos-list">
                        <span style="float:left;width: 75px;height: 75px;background-image: url({{ asset('storage/page/'.$item->featured_image) }});background-size: cover;background-position: center center;border-radius: 16px;">
                        </span>
