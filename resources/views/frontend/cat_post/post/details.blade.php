        ...
        <div class="row">
            <div class="col">
                <div class="post-details-image">
                    <span  style="float:left; width: 100%; height: 270px; background-image: url({{ asset('storage/post/'.$post->featured_image) }}); background-size: cover; background-position: center center; border-radius: 30px;"> </span>
                </div>
                    @php
