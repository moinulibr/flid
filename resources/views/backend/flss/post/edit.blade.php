...
<div class="page-content-wrapper">
	...
	<div class="page-content">
		...
		<div class="card">
			<div class="card-body">
                <form action="{{route('admin.flss.post.update',$post->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="postbox mb-5">
                                ...
                                {{--  <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#imageModal"> 
                                    ...
                                    <img width="100%" height="90" src="{{ asset('storage/flss-post/'.$post->featured_image) }}" class="attachment-60x60 size-60x60" alt="" loading="lazy">
                                    @else
