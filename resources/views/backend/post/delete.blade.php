...
{{-- <div class="modalEditShow modal fade modal-dialog modal-dialog-centered modal-dialog-otherServiceable" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"> --}}
    ...
    <form action="{{route('admin.post.deleting',$post->id)}}" method="POST">
        @csrf
            ...
            <div class="modal-content modal-sm">
                ...
                <div class="modal-body">
                    ...
                    <div class="postbody">
                        ...
                        <img width="120" height="80" src="{{ asset('storage/post/'.$post->featured_image) }}" class="attachment-60x60 size-60x60" alt="" loading="lazy">
                        @else
