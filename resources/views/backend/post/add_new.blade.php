                            ...
                            <div class="postbox mb-3">
                                ...
                                <div class="postbox-body">
                                    ...
                                    <div id="time" class="misc-pub-section mb-3">
                                        <i class="bi bi-clock-history"></i> Time: <span id="post-status-display"> $time = date("g:i:s a"); echo $time;  </span>
                                    </div> --}}
                                </div>
                                        ...
                                        @foreach($categories as $category)
                                            ...
                                            <div class="{{$class}}">
                                                <div class="form-check">
                                                    ...
                                                    <input class="form-check-input" name="{{$name}}[]" type="checkbox" value="{{$category->id}}" />
                                                </div>
                                            </div>
                                        @endforeach
                                    </div> 
