			...
			<div class="page-content-wrapper">
				...
				<div class="page-content">
					...
					<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
						<div class="breadcrumb-title pe-3">Pending Users</div> 
						...
						<div class="card-body">
							...
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item" role="presentation">
									<a class="nav-link {{$utyUrl == NULL ? 'active' : ''}}" href="{{route('admin.user.pending.index','')}}">
										All <span>({{$userCountables->count()}})</span>
									</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link {{$utyUrl == 'administrator' ? 'active' : ''}}" href="{{route('admin.user.pending.index','administrator')}}">
										Administrator
										<span>({{$userCountables->where('user_role_id',1)->count()}})</span>
									</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link {{$utyUrl == 'author' ? 'active' : ''}}" href="{{route('admin.user.pending.index','author')}}">
										Author  
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link {{$utyUrl == 'editor' ? 'active' : ''}}" href="{{route('admin.user.pending.index','editor')}}">
										Editor  
       ...
       /*  $(document).on('click', '.deletedAll', function (){
            ...
            $(document).on('click', '.deletedAllButton', function (){
               ...
               var cstatus = 1;
                ...
                let decirectUrl = "{{route('admin.user.pending.index')}}";
                $.ajax({
                    url: url,
