        ...
        <div class="footer-bar footer-bar-5 clearfix" class="" style="left: 50%; transform: translateX(-50%);">
            <!--a href="index.php">
                <svg
            ...
            <a href="{{route('frontend.view.media.list')}}">
                <svg
                    xmlns="https://www.w3.org/2000/svg"
                    width="24"
                    height="24"
            ...
            <a href="{{route('frontend.home.index')}}" class="active-nav">
                <svg
                    xmlns="https://www.w3.org/2000/svg"
                    width="24"
                    height="24"
            ...
            <a href="{{route('frontend.about.us.list')}}">
                <svg
                    xmlns="https://www.w3.org/2000/svg"
                    width="24"
                    height="24"
